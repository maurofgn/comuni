/*
 * Created on 5 set 2016 ( Time 12:05:45 )
...
//		Page<Provincia> page = pageEntity.map(this::convertToProvincia);	//method reference. need at least java 8
	...
	public List<Provincia> findAll() {
		...
		return convert(provinciaJpaRepository.findAll(sort));
	}
	...
	@Override
	public Long count() {
		return provinciaJpaRepository.count();
	}
	...
	/**
	 * convert all elements of entities from ProvinciaEntity To Provincia
	 * @param entities
	 * @return List<Provincia>
	 */
	private List<Provincia> convert(Iterable<ProvinciaEntity> entities) {

		List<Provincia> retValue = new LinkedList<Provincia>();
		for(ProvinciaEntity provinciaEntity : entities) {
			retValue.add(provinciaServiceMapper.mapProvinciaEntityToProvincia(provinciaEntity));
		}
		return retValue;
	}
